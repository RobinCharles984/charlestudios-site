...
export function ProjectDetails() {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_URL}/projects/${slug}`)
      .then(res => { 
        // Normaliza para garantir que 'types' sempre exista como array
        const data = res.data;
        if (!data.types) {
  ...
  // ✅ CORREÇÃO: Usa .includes() na lista de tipos
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white font-sans pb-10">
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div>
            {/* ✅ CORREÇÃO: Mapeia a lista de tipos para criar badges */}
            ...
            <div className="mb-12">
                ...
                <div className="flex flex-wrap gap-2 mb-0">
                    ...
                    <button
                        ...
                        activeQuizIndex === index ? 'bg-white text-slate-900' : 'bg-slate-800 text-slate-400 hover:bg-slate-700'
                        }`}
                    >
                        📄 {quiz.fileName}
                    </button>
